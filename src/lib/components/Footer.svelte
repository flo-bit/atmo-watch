<footer class="relative z-10 border-t border-base-800">
	<div
	...
	>
		...
		<div class="mt-7 flex flex-col items-center md:order-1 md:mt-0 md:items-start">
			<a
			...
			<p class="mt-2 text-center text-xs text-base-400">
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="underline decoration-current/40 underline-offset-2 hover:text-white"
				>
					JustWatch</a
				>.
			</p>
