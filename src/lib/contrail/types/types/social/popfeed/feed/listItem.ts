...
const _bookProgressSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.feed.listItem#bookProgress")),
		/**
...
const _identifiersSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.feed.listItem#identifiers")),
		/**
		 * Amazon Standard ID
		 */
	...
	/*#__PURE__*/ v.object(
		{
			 ...
			 * @maxLength 50
			 */
			"listType": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.constrain(
				/*#__PURE__*/ v.string(),
				[/*#__PURE__*/ v.stringLength(0, 50)]
			)),
			/**
			...
			"status": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string<"#abandoned" | "#backlog" | "#finished" | "#in_progress" | (string & {})>()),
			/**
...
const _watchedEpisodeSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.feed.listItem#watchedEpisode")),
