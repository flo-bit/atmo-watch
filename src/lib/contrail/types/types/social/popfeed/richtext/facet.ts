...
const _byteSliceSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.richtext.facet#byteSlice")),
		/**
		 * @minimum 0
		 */
...
const _linkSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.richtext.facet#link")),
	"uri": /*#__PURE__*/ v.genericUriString(),
});
const _mainSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.richtext.facet")),
		get "features"() {
...
const _mentionSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.richtext.facet#mention")),
	"did": /*#__PURE__*/ v.didString(),
});
const _tagSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("social.popfeed.richtext.facet#tag")),
		/**
		 * @maxLength 640
		 * @maxGraphemes 64
		 */
		"tag": /*#__PURE__*/ v.constrain(
			/*#__PURE__*/ v.string(),
			[
