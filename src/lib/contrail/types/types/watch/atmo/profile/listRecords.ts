...
const _profileEntrySchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("watch.atmo.profile.listRecords#profileEntry")),
...
const _recordSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("watch.atmo.profile.listRecords#record")),
		...
		get "value"() {
			return SocialPopfeedActorProfile.mainSchema
		},
	}
);
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		"watch.atmo.profile.listRecords": mainSchema;
	}
}
